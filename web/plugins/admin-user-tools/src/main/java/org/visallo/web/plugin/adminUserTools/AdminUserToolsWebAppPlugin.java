...
public class AdminUserToolsWebAppPlugin implements WebAppPlugin {
    ...
    public void init(WebApp app, ServletContext servletContext, Handler authenticationHandler) {
        ...
        app.registerJavaScriptTemplate("/org/visallo/web/adminUserTools/UserAdminPlugin.jsx");
        app.registerJavaScriptTemplate("/org/visallo/web/adminUserTools/WorkspaceList.jsx");
        app.registerJavaScriptTemplate("/org/visallo/web/adminUserTools/LoadUser.jsx");
        app.registerJavaScriptTemplate("/org/visallo/web/adminUserTools/UserTypeaheadInput.jsx");
